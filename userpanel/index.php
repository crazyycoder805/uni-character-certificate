...
$total_users = $pdo->read("users");
$total_bookings = $pdo->read("bookings");
$total_products = $pdo->read("food");

$total_cuppons = $pdo->read("cuppons");
$total_categories = $pdo->read("food_categories");



$total_variations = $pdo->read("food_variations");
$total_payments = $pdo->read("stripe_payments");
                        ...
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Users</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_users); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Bookings</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_bookings); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Products</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_products); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Cuppons</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_cuppons); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Categories</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_categories); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Variations</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_variations); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="card ad-info-card">
                            <div class="card-body dd-flex align-items-center">
                                ...
                                <div class="icon-info-text">
                                    <h5 class="ad-title">Total Payments</h5>
                                    <h4 class="ad-card-title"><?php echo count($total_payments); ?></h4>
                                </div>
                            </div>
                        </div>
                    </div>
